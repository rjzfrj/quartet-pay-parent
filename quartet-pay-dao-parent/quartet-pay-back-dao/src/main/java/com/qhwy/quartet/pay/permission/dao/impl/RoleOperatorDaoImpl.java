...
public class RoleOperatorDaoImpl extends BaseDaoImpl<RoleOperator> implements RoleOperatorDao {
	 ...
	 * @return
	 */
	public List<RoleOperator> listByRoleId(Long roleId) {
	...
	@Override
	public List<Map<String,Object>> listOperatorRoleByOperatorId(Long operatorId) {
		return super.getSqlSession().selectList(getStatement("listOperatorRoleByOperatorId"), operatorId);
	}
