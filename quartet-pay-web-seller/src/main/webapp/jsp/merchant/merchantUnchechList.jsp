...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 菜单管理<span class="c-gray en">&gt;</span>待审核商户管理 <span class="c-gray en">&gt;</span> <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c"> 
		<form id="pageform" title="workList" action="${baseURL}/approval/merchants/list" method="post">
...
<!-- 		<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> -->
		...
		<a href="javascript:void(0)" onclick="batchUpdate()"id=unchech class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 认证</a>
	</span> 
		...
		<tbody>
			...
			<tr class="text-c">
				<td class="checkBox">
								...
								<td>${item.name}</td>
								<td >
								<c:if test="${item.status==3}"><span class="label radius">待审核</span></c:if>
								</td>
								<td>
