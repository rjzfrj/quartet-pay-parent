...
<html>
	...
	<article class="page-container">
		...
		<form  action="${baseURL}/mt/organization/editFeeRate.action"  method="post" id="pageform" class="form form-horizontal" >
	...
	$(function(){
		...
		$("#pageform").validate({
			...
			submitHandler:function(form){
				$.ajax({
					type:'post',
					url:'${baseURL}/mt/organization/editFeeRate',
