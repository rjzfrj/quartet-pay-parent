...
<html>
	...
	<title>添加公司注册信息 </title>
	</head>
	<body>
	<article class="page-container">
		<!-- <form action="" method="post" class="form form-horizontal" id="form-member-add"> -->
		<form  action="${baseURL}/mt/organization/registerCompany.action"  method="post" id="pageform" class="form form-horizontal" enctype="multipart/form-data">
		<input type="hidden" name="orgId" value="${organization.orgId}" />
		<input type="hidden" name="returnUrl" value="${baseURL}/mt/organization/registerOrgBasic.action?orgId=${organization.orgId}" />
		...
		<input type="hidden" id="realAmount" value="${orgRegister.realAmount}" />
			...
			<div id="gongsiInfo">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>机构营业执照号码：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input class="input-text" style="width:300px;" name="licenseCode" value="${orgRegister.licenseCode}" type="text" datatype="*" nullmsg="请填写机构营业执照号码！" />
					</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input class="input-text Wdate" style="width:300px;" readonly="readonly" name="licenseCodeValid" value='<fmt:formatDate value="${orgRegister.licenseCodeValid}" pattern="yyyy-MM-dd"/>' type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',enableKeyboard:false})" datatype="*" nullmsg="请填写机构营业执照号码有效期！" />
					</div>
				</div>
				
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">机构注册地址：</label>
					<div class="formControls col-xs-8 col-sm-9">
			...
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
					<a href="returnOrgBasic.action?orgId=${organization.orgId}"><input class="btn btn-primary radius" type="button" value="&nbsp;&nbsp;上一步&nbsp;&nbsp;" /></a>
