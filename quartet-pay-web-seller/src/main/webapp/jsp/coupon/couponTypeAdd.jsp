...
<title>修改优惠券商品类型</title>
</head>
<body>
<article class="page-container">
	<!-- <form action="" method="post" class="form form-horizontal" id="form-member-add"> -->
	<form  action="${baseURL}/coupon/Type/add"  method="post" id="pageform" class="form form-horizontal" >
			...
			<div class="formControls col-xs-8 col-sm-9">
			   <span class="select-box" style="width:150px;">
					<select name="sellerId" class="select" >
						<c:forEach var="item" items="${list2}"  varStatus="st"> 
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
			  <input type="text" name="typeCode"   class="input-text" style="width:150px" />&nbsp;
			</div>
		</div>
