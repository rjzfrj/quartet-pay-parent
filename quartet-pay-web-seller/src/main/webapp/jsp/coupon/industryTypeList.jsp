...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 行业类型管理<span class="c-gray en">&gt;</span>行业类型管理<span class="c-gray en">&gt;</span><a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c"> 
		<form id="pageform" title="workList" action="${baseURL}/industry/type/list" method="post">
						...
						<input type="hidden" name="numPerPage" value="${pageBean.numPerPage}" id="numPerPage">
						 类型名称：
						<input type="text" name="typeName" value="${pmsIndustryType.typeName}" class="input-text" style="width:180px"  />&nbsp;
						 父级名称：
						<input type="text" name="parentName" value="${pmsIndustryType.parentName}" class="input-text" style="width:180px"  />&nbsp;
						 MCC：
						<input type="text" name="mcc" value="${pmsIndustryType.mcc}" class="input-text" style="width:180px"  />&nbsp;
	...
	<span class="l">
		...
		<a href="javascript:;" onclick="show('添加行业类型','${baseURL}/industry/type/addUI','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>添加行业类型</a>
			...
			<c:forEach var="item" items="${pageBean.recordList}" varStatus="st">
			  <tr class="text-c">
				...
				<td><fmt:formatDate value="${item.editTime}" pattern="yyyy-MM-dd　HH:mm:ss"/> </td>
				 <td class="td-manage">
				<a title="编辑" href="javascript:;" onclick="show('编辑','${baseURL}/industry/type/toEditUI?typeId=${item.typeId}','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
