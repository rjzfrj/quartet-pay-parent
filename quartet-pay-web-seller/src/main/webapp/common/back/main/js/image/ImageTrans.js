...
//======  调用
function ImageTransCall(idContainer,imgSrc){
	var container = $$(idContainer), src = imgSrc,
	options = {
		onPreLoad: function(){ container.style.backgroundImage = "url('/proOne/common/js/image/loading.gif')";
