...
<article class="page-container">
	...
	<form  action="${baseURL}/channel/org/add"  method="post" id="pageform" class="form form-horizontal" >
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>渠道名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input name="name"  type="text" class="input-text" style="width:300px;"/>
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input name="address" type="text" class="input-text" style="width:300px;"  autocomplete="off"/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>手机：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input name="mobile" type="text" class="input-text" style="width:300px;" autocomplete="off"/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>座机：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input name="phone" type="text" class="input-text" style="width:300px;"  autocomplete="off"/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>负责人姓名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input name="legalName" type="text" class="input-text" style="width:300px;" autocomplete="off"/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>负责人身份证号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input name="idCard" type="text" class="input-text" style="width:300px;"  autocomplete="off"/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>邮编：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input name="post" type="text" class="input-text" style="width:300px;" autocomplete="off"/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>email：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input name="email" type="text" class="input-text" style="width:300px;"  autocomplete="off"/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>业务员名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input name="salesman" type="text" class="input-text" style="width:300px;" autocomplete="off"/>
			</div>
		</div>
		<div class="row cl">
