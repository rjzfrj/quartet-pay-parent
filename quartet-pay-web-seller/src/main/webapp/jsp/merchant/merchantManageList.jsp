...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 菜单管理<span class="c-gray en">&gt;</span>商户列表管理 <span class="c-gray en">&gt;</span> <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<span class="l">
		...
		<a href="javascript:;" onclick="openPage('添加商户','${baseURL}/merchant/merchantlist/addUI')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加商户</a>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				<td><input type="checkbox" value="${item.mcode}" name="ids"></td>
				<td>${st.index+1}</td>
					<td>${item.mcode }</td>
								<td>${item.merName}</td>
								<td>
				...
				<td class="td-manage">
				<a title="编辑" href="javascript:;" onclick="show('编辑','${baseURL}//merchant/merchantlist/toEditUI?mcode=${item.mcode}','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
