...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理<span class="c-gray en">&gt;</span> 错误码管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c"> 
		<form id="pageform" title="workList" action="${baseURL}/sys/errorcode/list" method="post">
						...
						错误代码：
						<input type="text" name="code" value="${param.code}" class="input-text" style="width:250px"  />&nbsp;
						错误描述：
						<input type="text" name="remark" value="${param.remark}" class="input-text" style="width:250px" />
						友好描述：
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<a title="编辑" href="javascript:;" onclick="show('编辑','${baseURL}/sys/errorcode/toEditUI?errorCodeId=${item.id}','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
				...
				<a title="删除" href="javascript:;" onclick="deleteObj(this,'id=${item.id}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
