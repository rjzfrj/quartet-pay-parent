...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 终端管理<span class="c-gray en">&gt;</span> 终端管理<span class="c-gray en">&gt;</span>终端管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c"> 
		<form id="pageform" title="workList" action="${baseURL}/merchant/terminal/list" method="post">
						...
						<input type="hidden" name="numPerPage" value="${pageBean.numPerPage}" id="numPerPage">
						 终端号：
						<input type="text" name="tcode" value="${pmsTerminal.tcode}"  class="input-text" style="width:200px"  />&nbsp;
						商户号：
						<input type="text" name="mcode" value="${pmsTerminal.mcode}" class="input-text" style="width:200px"  />&nbsp;
						状态：
						<select name="status">
	...
	<span class="l">
		...
		<a href="javascript:;" onclick="show('添加中端','${baseURL}/merchant/terminal/addUI','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>添加终端</a>
	</span> 
